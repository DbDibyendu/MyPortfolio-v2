  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7x1 mx-auto">
        ...
        >
          <img src={vault} alt="DB" className="w-18 h-9 object-contain" />
        ...
        <ul className="list-none hidden sm:flex flex-row gap-10" style={{ color: '#FFFFFF' }}>
          {navLinks.map((link) => {
            return (
              <li
                key={link.id}
                className={`${active === link.title ? "text-white" : "text-white"
        ...
        <div className="sm:hidden flex flex-1 justify-end items-center">
          ...
          >
            <ul className="list-none flex justify-end items-start flex-col gap-4" style={{ color: '#FFFFFF' }}>
              {navLinks.map((link) => {
                return (
                  <li
                    key={link.id}
